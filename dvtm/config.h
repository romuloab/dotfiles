...
static Key keys[] = {
	...
	{ MOD,   '\t',          { focuslast,      { NULL }                    } },
	{ MOD,   'q',           { quit,           { NULL }                    } },
        // why would anyone want to type in all clients at the same time!?
	...
	{ MOD,   'a',           { send,           { (const char []){MOD, 0} } } },
	{ MOD,   MOD,           { send,           { (const char []){MOD, 0} } } },
	{ NOMOD, KEY_SPREVIOUS, { scrollback,     { "-1" }                    } },
	{ NOMOD, KEY_SNEXT,     { scrollback,     { "1"  }                    } },
	{ MOD,   (char)0x51,    { scrollback,     { "-1" }                    } },
	{ MOD,   (char)0x49,    { scrollback,     { "1"  }                    } },
};
